...
<head>
  ...
  <title>Sistem Informasi Inventaris Sarana & Prasarana SMK</title>
  ...
  <div class="container">
    <div class="login-box">
      ...
      <center>
        ...
        <!-- <h3>INVENTARIS SARANA RS.ST.ELISABETH BEKASI</h3> -->
      ...
      <div class="login-box-body">
        ...
        <center>
          <h3 style="color:#666" class="text-bold">INVENTARIS <br> RS.ST.ELISABETH BEKASI</h3>
          <img src="assets/logo.png" class="img-responsive" style="width: 150px">
        </center>
